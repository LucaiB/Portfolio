...
function_info functions[] = {
    ...
    {sum_multiple_accum_C, "sum_multiple_accum_C: faster than sum_C"},

    /* source code for this version is in sum_simple.s */
    {sum_simple, "sum_simple: simple ASM implementation"},

    // ADD ENTRIES HERE!
    {sum_unrolled2, "sum_unrolled2: should be faster than sum_simple"},
    {sum_unrolled4, "sum_unrolled4: should be faster than sum_unrolled2"},
